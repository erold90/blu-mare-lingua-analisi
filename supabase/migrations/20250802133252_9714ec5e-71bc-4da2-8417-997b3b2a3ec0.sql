...
-- Update other functions to have SET search_path
CREATE OR REPLACE FUNCTION public.generate_apartment_specific_weeks(target_year integer, copy_from_year integer DEFAULT NULL::integer)
RETURNS integer
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO 'public'
