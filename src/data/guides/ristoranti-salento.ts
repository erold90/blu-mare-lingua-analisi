  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        ...
        <p><strong>Ristorante Al Porticciolo</strong> - Sul Lungomare Cristoforo Colombo, pesce freschissimo e piatti tipici pugliesi con verdure a km 0. Terrazza vista mare sulla baia. Prezzo medio: €35-45 a persona. Prenotazione consigliata. Tel: +39 0833 711515.</p>
        <p><strong>Profumo di Mare</strong> - Location con vista tramonto spettacolare, pesce cucinato a regola d'arte. Un gioiellino del Salento. €30-40 a persona.</p>
        <p><strong>Torreantigua</strong> - Frittura di pesce eccezionale, molto leggera e di qualità. Vista meravigliosa e ottima accoglienza. €25-35 a persona.</p>
        <p><strong>Ristorante Le Scalelle</strong> - All'interno dell'Hotel La Collinetta, piatti tipici salentini e pesce fresco, ampia terrazza vista mare. Prezzi abbordabili. €20-30 a persona.</p>
      `,
      highlights: [
        'Al Porticciolo: pesce fresco sul lungomare',
        'Profumo di Mare: tramonto spettacolare',
        'Torreantigua: frittura eccezionale',
    ...
    },
    {
      ...
      content: `
        ...
        <p><strong>Lido Maldive del Salento</strong> - Lo storico stabilimento balneare con ristorante, direttamente sulla spiaggia delle "Maldive". Pranzo con vista mare cristallino. €30-40 a persona.</p>
        <p><strong>Ristorante Ikarus</strong> - A Marina di Pescoluse, menù di pesce e carne, tantissimi antipasti, ottime pizze anche d'asporto. €25-35 a persona.</p>
        <p><strong>Bar-Ristorante Eden</strong> - Il primo agribeach d'Italia! Orto che si affaccia sulle Maldive del Salento, pietanze con ingredienti genuini e biologici. Esperienza unica. €30-40 a persona.</p>
        <p><strong>Consiglio:</strong> molti stabilimenti balneari offrono servizio ristorante in spiaggia - comodo per non spostarsi! Provate le pucce (panini salentini) farcite con ingredienti locali nei chioschi.</p>
      `,
      highlights: [
        'Lido Maldive: pranzo sulla spiaggia famosa',
        'Eden: primo agribeach d\'Italia',
        'Ikarus: pesce e pizza a Marina',
    ...
    },
    {
      ...
      content: `
        ...
        <p><strong>Trattoria La Puritate</strong> - Nel centro storico vicino alla chiesa omonima, istituzione locale dal servizio impeccabile. Pesce fresco, gamberi al sale divini, atmosfera autentica. €35-50. Prenotate, soprattutto d'estate!</p>
        <p><strong>Gelateria Sandrino</strong> - Una delle gelaterie più rinomate del Salento, gelato al naturale privo di conservanti. Specialità: cono con cioccolata bianca all'interno. Da non perdere!</p>
        <p><strong>Bar Savino</strong> - Tra le migliori 5 gelaterie del Salento, famoso per lo Spumone originale. Tradizione, ricerca e innovazione dal 1999.</p>
        <p><strong>Caffé Duomo</strong> - In pieno centro storico, perfetto per gelato durante la passeggiata. Ampia varietà di gusti.</p>
      `,
      highlights: [
        'La Puritate: istituzione storica',
        'Sandrino: gelato naturale top',
        'Bar Savino: spumone originale',
    ...
    },
    {
      ...
      content: `
        ...
        <p><strong>Masseria Le Stanzie</strong> (Supersano, 30 min) - Una delle masserie più antiche del Salento, risalente al 1500. Cucina contadina genuina in ambienti riscaldati da camini, decorati con pomodori e peperoncini appesi. Menu con sagne ncannullate, pancotto, formaggi e pasta fatta in casa. Verdure dell'orto e carne di allevamento proprio. €35-45. Aperta pranzo e cena (chiusa lunedì). Tel: +39 0833 632438. Prenotazione obbligatoria.</p>
        <p><strong>Consiglio:</strong> le masserie richiedono prenotazione con anticipo, soprattutto in agosto. La visita guidata alla Masseria Le Stanzie è un'esperienza imperdibile - chiedete al proprietario!</p>
      `,
      highlights: [
        'Masseria Le Stanzie: dal 1500',
