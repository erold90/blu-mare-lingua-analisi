...
export const apartments: Apartment[] = [
  {
    ...
    size: 65,
    price: 120,
    services: ["WiFi", "Naturalmente fresco", "Parcheggio", "TV", "Ampia Veranda", "Doccia Esterna", "Barbecue", "Forno a legna"],
  ...
  },
  {
    ...
    size: 90,
    price: 150,
    services: ["WiFi", "Aria Condizionata", "Parcheggio", "TV", "Terrazzo panoramico", "Doccia Esterna"],
    images: ["placeholder.svg"],
  ...
  },
  {
    ...
    size: 45,
    price: 100,
    services: ["WiFi", "Aria Condizionata", "Parcheggio", "TV", "Terrazzo vista mare", "Doccia Esterna"],
    images: ["placeholder.svg"],
  ...
  },
  {
    ...
    size: 70,
    price: 130,
    services: ["WiFi", "Aria Condizionata", "Parcheggio", "TV", "Zona esterna privata", "Doccia Esterna"],
    images: ["placeholder.svg"],
