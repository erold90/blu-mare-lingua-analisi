...
export const SupabasePricesProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const initializePricesFor2025 = useCallback(async () => {
    ...
    // Definisce i prezzi della tabella fornita dall'utente con le date e i prezzi corretti
    const priceData = [
      // Giugno 2025 - dal 2 al 29 giugno
      ...
      // Settembre 2025 - dal 1 al 29 settembre
