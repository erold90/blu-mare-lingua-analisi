...
const WhatsAppButton = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-50 bg-green-500 hover:bg-green-600 text-white p-2 rounded-full shadow-md transition-all duration-300 hover:scale-105"
