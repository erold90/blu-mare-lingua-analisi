...
const AdminAnalyticsRefactored = () => {
  const { quoteLogs, siteVisits, metrics, loading, error, refreshData, testConnection, cleanupOldData } = useAnalyticsCore();
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Sistema ottimizzato - Versione 2.0
            </p>
          </div>
        </div>
...
export default AdminAnalyticsRefactored;
