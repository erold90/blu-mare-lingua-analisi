    ...
    <div className="container px-4 py-8 md:py-12">
      ...
      <div className="prose prose-slate max-w-none">
        <p className="text-muted-foreground mb-6">
          Ultimo aggiornamento: {new Date("2025-05-20").toLocaleDateString("it-IT")}
        </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 my-4 space-y-2">
            <li>
              <a href="https://support.google.com/accounts/answer/61416" className="text-primary underline">Google Chrome</a>
            </li>
            <li>
              <a href="https://support.mozilla.org/it/kb/Attivare%20e%20disattivare%20i%20cookie" className="text-primary underline">Mozilla Firefox</a>
            </li>
            <li>
              <a href="https://support.microsoft.com/it-it/microsoft-edge/eliminare-i-cookie-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" className="text-primary underline">Microsoft Edge</a>
            </li>
            <li>
              <a href="https://support.apple.com/it-it/guide/safari/sfri11471/mac" className="text-primary underline">Safari</a>
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Se hai domande sulla nostra Cookie Policy, contattaci all'indirizzo email: macchiaforcato@gmail.com
          </p>
        </section>
      </div>
    </div>
